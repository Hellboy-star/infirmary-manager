                ...
                <div class="panel-body p-0">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-md-12 card-body  table-responsive" id="show_at">
                            ...
                            <div class="col-md-12 card-body  table-responsive" id="show_at">
                                <div class="card-body">
                                    <form method="POST" action="{{route('absent.update', ['id' => $id->id])}}">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-6 mb-3">
                                                ...
                                                <input type="text" class="stype form-control form-control- sm @error('content') is-invalid @enderror "
                                                    name="TYPEABS" id="TYPEABS" placeholder=""  required value="{{$id->TYPEABS}} "/>
                                            </div>
                                            <div class="col-xxl-6 mb-3">
                                                <label class="form-label"
                                                ...
                                                <input type="text" class="scause form-control form-control- sm @error('content') is-invalid @enderror "
                                                    name="CAUSE" id="CAUSE" placeholder=""  required value="{{$id->CAUSE}} "/>
                                            </div>
                                            <div class="col-xxl-6 mb-3">
                                                <label class="form-label"
                                                ...
                                                <input type="date" class="sdatecons form-control form-control-sm @error('content') is-invalid @enderror" 
                                                    name="DEBUT" id="DEBUT" required value="{{ $id->DEBUT }}">
                                            </div>
                                            <div class="col-xxl-6 mb-3">
                                                <label class="form-label"
                                                    for="exampleInputPassword1">Reprise:</label>
                                                <input type="date" class="sdatecons form-control form-control-sm @error('content') is-invalid @enderror" 
                                                    name="REPRISE" id="REPRISE" readonly value="{{ $id->REPRISE }}">
                                            </div>
                                            ...
                                            <div class="col-xxl-6 mb-3">
                                                ...
                                                <input type="text" class="snbrarret form-control form-control- sm @error('content') is-invalid @enderror "
                                                    name="NBRARRET" id="NBRARRET" placeholder=""  value="{{$id->NBRARRET}} "/>
                                            </div>
                                            ...
                                            <div class="col-xxl-6 mb-3">
                                                ...
                                                <input type="text" class="sobservation form-control form-control-sm @error('content') is-invalid @enderror " name="TABLES" id="TABLES" required value=" Absentéisme " hidden >
                                                <input type="text" class="sobservation form-control form-control-sm @error('content') is-invalid @enderror " name="ATABLES" id="ATABLES" required value=" abs " hidden >
