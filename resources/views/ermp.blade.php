...
<div id="content" class="app-content">
    ...
    <div>
        <h1>FORMULAIRE DES MALADIES PROFESSIONNELLES</h1>
        <div class="col-xl-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 mb-3">
                                                <label class="form-label" for="exampleInputPassword1"> Date de
                                                    Consultation:</label>
                                                <input style="width: 100%;" type="date" name="DATEMP" id=""
                                                    placeholder="" required class="sdiagnostic form-control form-control-sm @error('content') is-invalid @enderror " />
                                            </div>
                                            <!-- <div class="col-xl-3 mb-3">
                                            ...
                                            <div class="col-xl-3 mb-3">
                                                ...
                                                <input style="width: 100%;" type="text" name="NBRSA" id=""
                                                    placeholder="" required class="snbrsa form-control form-control-sm @error('content') is-invalid @enderror "
                                                    readonly />
                                            </div> -->
                                            <div class="col-xl-3 mb-3">
                                                ...
                                                <input style="width: 100%;" type="text" name="MPNUMTAB" id=""
                                                    placeholder="" required class="smpnumtab form-control form-control-sm @error('content') is-invalid @enderror " />
                                            </div>
                                            <div class="col-xl-3 mb-3">
                                                <label class="form-label" for="exampleInputPassword1"> Maladie
                                                    Professionnelle /
                                            ...
                                            <div class="col-xl-3 mb-3">
                                                ...
                                                <input style="width: 100%;" type="text" name="MALCARAPRO" id=""
                                                    placeholder="" required class="smalcarapro form-control form-control-sm @error('content') is-invalid @enderror " />
                                            </div>
                                            <div class="col-xl-3 mb-3">
                                                <label class="form-label" for="exampleInputPassword1"> Agent pathogène
                                                    suspecté:</label>
                                                <input style="width: 100%;" type="text" name="AGENTPATH" id=""
                                                    placeholder="" required class="sagentpath form-control form-control-sm @error('content') is-invalid @enderror " />
                                            </div>
                                            <div class="col-xl-3 mb-3">
                                                <label class="form-label" for="exampleInputPassword1"> Date de
                                                    déclaration
                                                    CNSS:</label>
                                                <input style="width: 100%;" type="date" name="DATE1CNSSMP" id=""
                                                    placeholder="" required class="sdate1cnss form-control form-control-sm @error('content') is-invalid @enderror " />
                                            </div>
                                            <div class="col-xl-3 mb-3">
                                                <label class="form-label" for="exampleInputPassword1"> Date d'avis
                                                    CNSS:</label>
                                                <input style="width: 100%;" type="date" name="DATE2CNSSMP" id=""
                                                    placeholder="" required class="sdate2cnss form-control form-control-sm @error('content') is-invalid @enderror " />
                                            </div>
                                            <div class="col-xl-3 mb-3">
                                            ...
                                            <div class="col-xl-3 mb-3">
                                                ...
                                                <textarea style="width: 100%;" type="text" name="TRAITEMENTMP" id=""
                                                    placeholder="" required class="straitement form-control form-control-sm @error('content') is-invalid @enderror ">
