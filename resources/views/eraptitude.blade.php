...
<div id="content" class="app-content">
    ...
    <div>
        <h1>FORMULAIRE DES APTITUDES </h1>
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-plugins-9">
                ...
                <div class="panel-body p-0">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- <h3 class="mt-10px">FORMULAIRE D'ENREGISTREMENTS D'APTITUDE</h3> -->
                        <div class="col-md-12 card-body  table-responsive" id="show_om">
                            <div class="card-body">
                                <form method="POST" action="{{route('aptitude.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="col-xl-3 mb-3">
                                        ...
                                        <div class="col-xl-3 mb-3">
                                            ...
                                            <input type="date"
                                                ...
                                                name="DATEAP" id="DATEAP" placeholder="" required />
                                        </div>
