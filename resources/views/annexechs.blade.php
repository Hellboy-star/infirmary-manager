@extends('def.def', ['titre'=>'Tableaux en Annexes du Rapport du Centre Hospitalier de Santé' ])
@section ('contenta')

<div id="content" class="app-content">

    <h1 class="page-header"> Tableaux en Annexe du Rapport du Centre Hospitalier de Santé </h1>
