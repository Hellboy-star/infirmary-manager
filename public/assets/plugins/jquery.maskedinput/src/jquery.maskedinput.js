(function(factory) { if (typeof define === 'function' && define.amd) { define(['jquery'], factory); } else if (typeof exports === 'object') { factory(require('jquery')); } else { factory(jQuery); } }(function($) {
    var ua = navigator.userAgent,
        ...
        caretTimeoutId;
    $.mask = { definitions: { '9': "[0-9]", 'a': "[A-Z]", '*': "[A-Z0-9]" }, autoclear: true, dataName: "rawMaskFn", placeholder: '_' };
    $.fn.extend({
            ...
            return this.trigger("unmask").each(function() {
                ...
                function androidInputEvent(e) {
                    ...
                    if (oldVal && oldVal.length && oldVal.length > curVal.length) {
                        ...
                        if (pos.begin < len) { if (!tests[pos.begin]) { pos.begin++; if (tests[pos.begin].test(lastEnteredValue)) { pos.begin++; } } else { if (tests[pos.begin].test(lastEnteredValue)) { pos.begin++; } } }
                        input.caret(pos.begin, pos.begin);
                    }
                    tryFireCompleted();
                }
                ...
                function keydownEvent(e) {
                    ...
                    if (k === 8 || k === 46 || (iPhone && k === 127)) {
                        ...
                        shiftL(begin, end - 1);
                        e.preventDefault();
                    } else if (k === 13) { blurEvent.call(this, e); } else if (k === 27) {
                        input.val(focusText);
                ...
                function keypressEvent(e) {
                    ...
                    var k = e.which || e.keyCode,
                        pos = input.caret(),
                        p, c, next;
                    if (e.ctrlKey || e.altKey || e.metaKey || k < 32) { return; } else if (k && k !== 13) {
                ...
                function checkVal(allow) {
                    ...
                    if (allow) { writeBuffer(); } else if (lastMatch + 1 < partialPosition) {
